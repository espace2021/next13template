...
function OverviewRating({ product }) {
    return <div className='overview-rating'>
        <div className='overview-rating-value'>{4}</div>
        <div className='overview-rating-stars'><Stars value="4" displayTotal={false} /></div>
        <div className='overview-rating-total'>{2} reviews</div>
    </div>
}
